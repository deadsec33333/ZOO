  ...
  if (document.documentMode || /Edge/.test(navigator.userAgent)) {
          ...
          if($(window).width()>=1025){
            $(this).closest('.our-critters-section').find('.critters-block-row + .critters-block-row ~ .critters-block-row').slideToggle(400, function(){
              ...
              if($.trim(el.text()) == 'See Less'){
                var body = $("html, body");
                body.stop().animate({scrollTop:el.closest('.our-critters-section').find('.critters-block-row').eq(2).offset().top - $('[data-elementor-type="header"]').outerHeight()}, 500);
              }
            });
          }else{
            $(this).closest('.our-critters-section').find('.critters-block-row ~ .critters-block-row').slideToggle(400, function(){
              ...
              if($.trim(el.text()) == 'See Less'){
                var body = $("html, body");
                body.stop().animate({scrollTop:el.closest('.our-critters-section').find('.critters-block-row').eq(1).offset().top - $('[data-elementor-type="header"]').outerHeight()}, 500);
              }
            });
    ...
    $(window).on('load',function(){
      if(jQuery(window.location.hash).length>0){
        ...
        $("html, body").animate({ scrollTop: jQuery(window.location.hash).closest('.phoenix-tabs-section').offset().top - $('[data-elementor-type="header"]').height() - adminbar }, 600);
      }
    ...
    $('a[href*="#"]').on('click',function(e){
      ...
      if(jQuery(this.hash).length>0){
        ...
        if ($('.phoenix-tabs-section').length){
          $("html, body").animate({ scrollTop: jQuery(this.hash).closest('.phoenix-tabs-section').offset().top - $('[data-elementor-type="header"]').height() - adminbar }, 600);
        }
